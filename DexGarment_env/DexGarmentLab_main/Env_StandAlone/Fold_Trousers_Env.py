...
def FoldTrousers(pos, ori, usd_path, ground_material_usd, data_collection_flag, record_video_flag):
    ...
    if record_video_flag and success:
        if not os.path.exists("Data/Fold_Trousers/video"):
            os.makedirs("Data/Fold_Trousers/video")
        env.env_camera.create_mp4(get_unique_filename("Data/Fold_Trousers/video/video", ".mp4"))
