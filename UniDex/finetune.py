...
def main(config):
    ...
    train_loader = DataLoader(train_dataset, batch_size=train_config.dataloader.batch_size, shuffle=True, num_workers=train_config.dataloader.num_workers, persistent_workers=True, collate_fn=custom_collate_fn, pin_memory=True)
    val_loader = DataLoader(val_dataset, batch_size=train_config.dataloader.batch_size, shuffle=False, num_workers=train_config.dataloader.num_workers, persistent_workers=True, collate_fn=custom_collate_fn, pin_memory=True)
